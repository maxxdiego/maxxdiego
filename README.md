...
- 🏰 **The Games API** — Uma campanha RESTful que ensina magos iniciantes a conjurar dados com Node.js e também com Python Flask. Node.js: [🔗 Acesse](https://github.com/maxxdiego/09_api_node_e_front_end) / Python - Flask: Node.js: [🔗 Acesse](https://github.com/maxxdiego/18_api_flask_games)
